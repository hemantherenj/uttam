<div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-0">
    <main>
            ...
            <div class="mb-1 w-full">
                ...
                <div class="sm:flex">
                    ...
                    <div class="flex items-center space-x-2 sm:space-x-3 ml-auto">
                        ...
                        <button class="btn" onclick="add_new_modal.showModal()">open modal</button>
                                        ...
                                        <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                            ...
                                            @if ($data->image_one)
                                                <img class="h-10 w-10 rounded-full"
                                                    src="{{ asset('storage/' . $data->image_one) }}"
                                                    alt="{{ $data->id }}">
                                            @else
                                                <img class="h-10 w-10 rounded-full"
                                            ...
                                            <div class="text-sm font-normal text-gray-500">
                                                ...
                                                <div class="text-sm font-normal text-gray-500"><a
                                                        ...
                                                        data-cfemail="7f111a1613510c16120c3f0816111b0c0b1a0d511c1012">[{{ $data->email }}]</a>
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                        ...
                                        <div class="text-sm font-normal text-gray-500">
                                            ...
                                            <div class="text-sm font-normal text-gray-500"><a
                                                    href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                    data-cfemail="a7c5c8c9c9cec289c0d5c2c2c9e7d0cec9c3d4d3c2d589c4c8ca">[email&#160;protected]</a>
                                            </div>
                                        </div>
                                    </td>
        ...
        <dialog id="add_new_modal" class="modal" wire:ignore.self>
            <div class="modal-box">
                <div class="flex justify-between items-center">
                    <h3 class="font-bold text-xg">Add File</h3>
                    <form method="dialog">
                        <button class="btn btn-xs btn-circle"> <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <form wire:submit='store'>
                        ...
                        <div class="mb-2 ">
                            <label class="form-control ">
                                ...
                                <input type="file" class="file-input file-input-bordered w-full"
                                    wire:model='image' accept="image/png,image/jpeg,image/jpg,image/gif,image/webp" />
                            </label>
                            @error('image')
                                <span class="text-red-500">{{ $message }}</span>
                            @enderror
                        ...
                        {{-- @if ($image)
                                    <img src="{{ $image->temporaryUrl() }}"
                                        class="w-full rounded-md object-contain my-2" />
                                @endif --}}
                        <div class="mb-2">
