{{-- <div class="pt-24 pb-10 mx-auto"> --}}
    <!-- Login Card -->
    <div class="bg-white pt-32 pb-16  dark:bg-gray-800 shadow-xl rounded-2xl p-8 w-full max-w-md mx-auto animate-fade-in">
        ...
        <div class="flex space-x-4">
            <button
                class="flex-1 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                Google
            </button>
            <button
                class="flex-1 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
        ...
        <p class="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
            ...
            <a href="{{ route('home') }}" wire:navigate class="text-indigo-500 hover:underline">Register</a>
        </p>
